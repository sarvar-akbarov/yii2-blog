        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Create new '.Yii::t('app','About Companies'),'class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
            ...
            'panel' => [
                'type' => 'default', 
                'heading' => '<i class="glyphicon glyphicon-list"></i>' . Yii::t('app', 'About Companies'),
